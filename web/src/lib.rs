...
#[wasm_bindgen]
pub fn draw_mandelbrot(ctx: &CanvasRenderingContext2d, width: u32, height: u32, simd: bool, max_iteration: u32) -> JsValue {
    ...
    let time_taken = performance.get_entries_by_name("mandelbrot").iter().next().unwrap();
